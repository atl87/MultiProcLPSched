...
/******************************CONTROL VARIABLES******************************/
    ...
    float fps[20], rds[20], ads[20];
    float edf[20], rds_edf[20], ads_edf[20];
...
/****************************************************************************************YOUR CODE GOES ABOVE****************************************************************************************/                
    ...
    for(int i=0;i<20;i++)
    {
        f_weighted<<(fps[i]/util_sum)<<"\t"<<(rds[i]/util_sum)<<"\t"<<(ads[i]/util_sum)<<"\t"<<(edf[i]/util_sum)<<"\t"<<(rds_edf[i]/util_sum)<<"\t"<<(ads_edf[i]/util_sum)<<"\n";
        f_normal<<"\n\n";
